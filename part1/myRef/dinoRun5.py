...
def main():
    ...
    y_pos_bg = 380
    points = 0
    font = pygame.font.Font('./myRef/Assets/NanumGothicBold.ttf', 20)
    obstacles = []
    death_count = 0
    ...
    def score():
        ...
        text = font.render(f'점수: {points}', True, (83,83,83))
...
def menu(death_count):
    ...
    while run:
        ...
        if death_count == 0:
            ...
            score = font.render(f'Your Score: {points}', True, (83,83,83))
